...
const UserMenu = () => {
  ...
  return (
    <div className='relative z-30' data-testid="user-menu-container">
      <div
      ...
      >
        ...
        <Link to="/profile" data-testid="profile-link">
          <MenuItem className="flex gap-2"
            ...
            <span className='font-bold text-[16px] mt-1' data-testid="username-display">
              {user?.username}
            </span>
          </MenuItem>
        </Link>

        <Link to="/profile/orders" data-testid="orders-link">
          <MenuItem className="flex gap-2"
            onClick={handleClose}>
        ...
        <MenuItem
          ...
          <div className='font-semibold w-full flex gap-2 items-center bg-button-gradient px-4 py-1 text-white rounded-sm'>
            ...
            <span className='font-bold text-[16px] mt-1' data-testid="logout-button">
              LogOut
            </span>
          </div>
        </MenuItem>
