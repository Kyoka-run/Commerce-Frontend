...
const Navbar = () => {
  ...
  return (
    <div className="h-[70px] bg-custom-gradient text-white z-50 flex items-center sticky top-0" data-testid="navbar">
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
        <Link to="/" className="flex items-center text-2xl font-bold" data-testid="brand-logo">
        ...
        <ul className={`flex sm:gap-10 gap-4 sm:items-center  text-slate-800 sm:static absolute left-0 top-[70px] sm:shadow-none shadow-md ${navbarOpen ? "h-fit sm:pb-0 pb-5" : "h-0 overflow-hidden"
          ...
          {user && user.id ? (
            <li className="font-[500] transition-all duration-150" data-testid="navbar-user-menu-container">
              <UserMenu />
            </li>
          ) : (
            <li className="font-[500] transition-all duration-150">
