...
export const DeleteModal = ({
  ...
  return (
    <Dialog open={open} onClose={setOpen} className="relative z-50" data-testid="delete-modal">
      <DialogBackdrop
        transition
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <DialogPanel
            ...
            data-testid="delete-modal-panel"
          >
            ...
            <div className="sm:flex sm:items-start">
              <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
                <FaExclamationTriangle className="text-red-600" data-testid="warning-icon" />
              </div>
              <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                ...
                <div className="mt-2">
                  <p className="text-sm text-textColor2 font-metropolis" data-testid="delete-confirmation-text">
