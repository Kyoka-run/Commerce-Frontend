...
const CartEmpty = () => {
  return (
    <div className="min-h-[800px] flex flex-col items-center justify-center" data-testid="cart-empty-container">
      <div className="flex flex-col items-center">
        <MdShoppingCart size={80} className="mb-4 text-slate-500" />
        <div className="text-3xl font-bold text-slate-700" data-testid="empty-cart-heading">
          Your cart is empty
        </div>
      ...
      <div className="mt-6">
        <Link
          ...
          data-testid="start-shopping-link">
          <MdArrowBack size={24} />
