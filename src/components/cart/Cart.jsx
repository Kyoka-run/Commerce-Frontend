...
const Cart = () => {
  ...
  return (
    <div className="lg:px-14 sm:px-8 px-4 py-10" data-testid="cart-container">
      <div className="flex flex-col items-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 flex items-center gap-3" data-testid="cart-heading">
      ...
      <div className="grid md:grid-cols-5 grid-cols-4 gap-4 pb-2 font-semibold items-center" data-testid="cart-table-header">
      ...
      <div className="border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row sm:px-0 px-2 flex-col sm:justify-between gap-4" data-testid="cart-summary">
        <div></div>
        <div className="flex text-sm gap-1 flex-col">
          <div className="flex justify-between w-full md:text-lg text-sm font-semibold">
            <span>Subtotal</span>
            <span data-testid="cart-subtotal">{formatPrice(newCart?.totalPrice)}</span>
          </div>
